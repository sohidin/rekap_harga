...
function populateFilters(){populateSelect('kabFilter',unique(state.all,'kab'),'Semua wilayah');populateDatalist('commodityFilter','commodityFilterList',unique(state.all,'commodity'));updateQualityDatalist(false);populateSelect('marketTypeFilter',unique(state.all,'marketType'),'Semua jenis pasar');refreshSearchCombo('commodityFilter');refreshSearchCombo('qualityFilter')}
